...
####	**Clarifiers**  
>  Clarifiers are treatment tanks similar to a septic tank. They allow solids to settle out of wastewater, and microorganisms to digest organic material in the water.
...
> Sequencing Batch reactors are a type of activated sludge system, where wastewater is added and then all treatment processes take place in a single 'batch' in just one tank before the wastewater is filtered, disinfected, and discharged. This type of treatment is good for communities with low or variable flow rates.
...
####	**STEP system**  
> Septic Tank Effluent Pumping (STEP) systems utilize a STEP tank, similar to a septic tank, at individual residences or businesses. Like a regular septic tank, a STEP tank allows solids to settle out, microorganisms to digest the waste, and oils to float to the top. Water from the middle of the tank, free of solids and oils, is pumped into the colletion system and flows to the centralized treatment facility. Since further treatment happens at this centralized facility, STEP systems are considered a centralized treatment system.
