...
#### These are some of the current main funding sources for small or rural wastewater treatment projects in Oregon. Descriptions are from the funding websites. For more information on any of these funding sources, click the title to view the website, including contact information.  
...
* ####  IFA, state. Maximum loan combination $10 million per project. Maximum grant award $750,000.   
...
* #### Business Oregon (OIFA), state funding. Maximum grant for wastewater improvements $2,500,000.   
...
## [RCAC Loans]() 
* #### Rural Community Assistance Corporation (RCAC), nonprofit.  
* #### 
